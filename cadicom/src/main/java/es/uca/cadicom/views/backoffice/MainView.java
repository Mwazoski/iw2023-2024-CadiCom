...
public class MainView extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        nav.addItem(new SideNavItem("Inicio", "admin", VaadinIcon.HOME.create()));
        nav.addItem(new SideNavItem("Clientes", "clientespanel", VaadinIcon.USERS.create()));
        nav.addItem(new SideNavItem("Tarifas", "tarifaspanel", VaadinIcon.PHONE_LANDLINE.create()));
